...
/// The maximum number of identifiers (inspired by sommelier, protocol v0)
pub const CROSS_DOMAIN_MAX_IDENTIFIERS: usize = 28;
/// As above, but for newer protocol (value inspired by wp_linux_dmabuf, protocol v1+)
pub const CROSS_DOMAIN_MAX_IDENTIFIERS_V2: usize = 4;
...
pub trait CrossDomainSendReceiveBase:
    Copy + Clone + Default + FromBytes + IntoBytes + Immutable
{
